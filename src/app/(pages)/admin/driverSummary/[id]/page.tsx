                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-800">
                        {activeSummary.currency} {activeSummary.totalEarnings?.toLocaleString()}
                      </p>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-800">
                        {activeSummary.currency} {activeSummary.pricePerMile?.toFixed(2)}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 mb-2 sm:mb-0">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-blue-800">
                        {fromDate ? fromDate.format('YYYY-MM-DD HH:mm') : "Any"} → {toDate ? toDate.format('YYYY-MM-DD HH:mm') : "Any"}
                      </span>
